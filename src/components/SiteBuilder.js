      ...
      component: () => (
        <div id="backgrounds">
          {backgroundImages.map((imgSrc, idx) => (
            <BackgroundContainers src={imgSrc} key={idx} />
          ))}
        </div>
      ),
    },
